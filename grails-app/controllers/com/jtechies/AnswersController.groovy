...
class AnswersController {
    ...
    def save(Answers answersInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'answers.label', default: 'Answers'), answersInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'answers.label', default: 'Answers'), params.id])
                redirect action: "index", method: "GET"
            }
