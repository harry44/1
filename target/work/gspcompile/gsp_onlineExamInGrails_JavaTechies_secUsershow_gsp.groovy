...
class gsp_onlineExamInGrails_JavaTechies_secUsershow_gsp extends GroovyPage {
...
printHtmlPart(20)
invokeTag('message','g',46,['code':("secUser.accountExpired.label"),'default':("Account Expired")],-1)
printHtmlPart(21)
invokeTag('formatBoolean','g',48,['boolean':(secUserInstance?.accountExpired)],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (secUserInstance?.accountLocked)) {
printHtmlPart(22)
invokeTag('message','g',55,['code':("secUser.accountLocked.label"),'default':("Account Locked")],-1)
printHtmlPart(23)
invokeTag('formatBoolean','g',57,['boolean':(secUserInstance?.accountLocked)],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (secUserInstance?.enabled)) {
printHtmlPart(24)
invokeTag('message','g',64,['code':("secUser.enabled.label"),'default':("Enabled")],-1)
printHtmlPart(25)
invokeTag('formatBoolean','g',66,['boolean':(secUserInstance?.enabled)],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (secUserInstance?.passwordExpired)) {
printHtmlPart(26)
invokeTag('message','g',73,['code':("secUser.passwordExpired.label"),'default':("Password Expired")],-1)
printHtmlPart(27)
invokeTag('formatBoolean','g',75,['boolean':(secUserInstance?.passwordExpired)],-1)
printHtmlPart(16)
}
printHtmlPart(28)
createTagBody(2, {->
...
invokeTag('link','g',83,['class':("edit"),'action':("edit"),'resource':(secUserInstance)],3)
printHtmlPart(30)
...
invokeTag('form','g',86,['url':([resource:secUserInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(32)
})
...
public static final long LAST_MODIFIED = 1499567917893L
