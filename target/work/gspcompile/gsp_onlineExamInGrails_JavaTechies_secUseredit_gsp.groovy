...
class gsp_onlineExamInGrails_JavaTechies_secUseredit_gsp extends GroovyPage {
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'secUser.label', default: 'SecUser'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',27,['bean':(secUserInstance),'var':("error")],3)
printHtmlPart(19)
})
...
invokeTag('form','g',38,['url':([resource:secUserInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1499567917536L
