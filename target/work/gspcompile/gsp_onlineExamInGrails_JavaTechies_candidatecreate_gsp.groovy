...
class gsp_onlineExamInGrails_JavaTechies_candidatecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/candidate/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',25,['bean':(candidateInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(candidateInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:candidateInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1499514364885L
