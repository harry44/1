...
class gsp_onlineExamInGrails_JavaTechies_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('image','asset',19,['src':("logo.gif"),'alt':("Java Techies"),'style':("height:60px;")],-1)
printHtmlPart(6)
createTagBody(2, {->
printHtmlPart(7)
...
printHtmlPart(9)
invokeTag('message','g',20,['code':("userMenu.logout.label"),'default':("Log Out")],-1)
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1499568112508L
