...
class gsp_onlineExamInGrails_JavaTechies_questioncreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(questionInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(questionInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:questionInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1499511255161L
